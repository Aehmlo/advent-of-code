...
fn main() {
	...
	do_the_solving_thing!(nine);
	do_the_solving_thing!(ten);
	do_the_solving_thing!(eleven);
	do_the_solving_thing!(twelve);
	do_the_solving_thing!(thirteen);
	do_the_solving_thing!(fourteen);
	do_the_solving_thing!(fifteen);
	do_the_solving_thing!(sixteen);
	do_the_solving_thing!(seventeen);
	do_the_solving_thing!(eighteen);
	do_the_solving_thing!(nineteen);
	do_the_solving_thing!(twenty);
	do_the_solving_thing!(twenty_one);
	do_the_solving_thing!(twenty_two);
	do_the_solving_thing!(twenty_three);
	do_the_solving_thing!(twenty_four);*/
	do_the_solving_thing!(twenty_five);
}
